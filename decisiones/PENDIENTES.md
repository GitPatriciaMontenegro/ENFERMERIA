...
| A16 | **Plan de cierre Fase 3 (Internacion)** — calendario de actividades para alcanzar 50/50 + cierre formal | Patricia + Lotty (lecciones) + Pedro (decision UCI Adulto) | Sab 2 may → Jue 8 may | Sin cierre formal no se valida la metodologia para escalar a UCI Adulto | 🟢 PLANIFICADA — 30 abr 2026. **Calendario acordado:** Sab 2 may = 4to C pase mañana→tarde (~4 nuevas). Lun 5 may = 6to C pase mañana→tarde + cerrar Recuperacion (~4 nuevas). Mar 6 may = personas remanentes + consolidacion. Mie 7 may = lecciones aprendidas con Lotty. Jue 8 may = cierre formal + decision UCI Adulto con Pedro. |
