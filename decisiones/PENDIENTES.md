...
| A13 | Trabajar con el **personal de apoyo al paciente** la actualizacion del instrumento de pase de turno y su aplicacion practica | Patricia | A definir (sigue pendiente) | Sin actualizacion el personal de apoyo sigue usando un proceso no formalizado en el manual | ABIERTA — 28 abr 2026. Patricia se hace cargo. Sin fecha definitiva — proxima oportunidad cuando Patricia este presencial sin compromisos previos. |
