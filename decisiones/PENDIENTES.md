...
| A10 | Proyecto ITAES enfermeria — trabajar requisitos + redactar plan de mejoras para no conformidades detectadas | Patricia + Maria Elena + Zuleidy + Julia | Mie 29 abr — Vie 8 may | Sin cumplimiento ITAES la institucion compromete la acreditacion | ABIERTA — 27 abr 2026. **Decision 27 abr:** se ejecutara EN PARALELO con las observaciones de Internacion (Opcion B). Lorena sigue su cronograma de Fase 3 (Grupo 7 + cierre el mie 29 abr); Patricia + Maria Elena + Zuleidy + Julia trabajan ITAES en paralelo. |
...
| A13 | Trabajar con el **personal de apoyo al paciente** la actualizacion del instrumento de pase de turno y su aplicacion practica | Patricia | A definir (post-retorno presencial) | Sin actualizacion el personal de apoyo sigue usando un proceso no formalizado en el manual | ABIERTA — 28 abr 2026. Patricia se hace cargo de este carril en paralelo. |
