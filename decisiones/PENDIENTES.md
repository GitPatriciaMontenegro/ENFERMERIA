...
|---|-----|-------|--------|----------------|--------|
| A1 | Trabajar con Lotty el diseno operativo de los Espacios de Contencion (Categoria 3) | Patricia + Lotty | Por agendar | Categoria 3 queda resuelta en papel pero sin mecanismo operativo | ABIERTA — 17 abr 2026. Lun 27 abr (retorno presencial Lotty): NO se avanzo. Re-agendar esta semana. |
...
| A7 | Seguimiento al refuerzo aplicado con personal 3er B sobre registro en expediente de todas las actividades (regla existente) | Patricia + Lorena | Proximos turnos | Si el refuerzo no tiene efecto, escalar con Maria Elena para accion mas firme | ✅ **CERRADA — 28 abr 2026 — VEREDICTO POSITIVO.** El grupo mañana del 3er B (Vargas + Mojica + Matta + Cespedes — el mismo del incumplimiento del 21 abr) hoy cumple la regla y MEJORA la trazabilidad: registra las actividades con HORA explicita. Refuerzo en sitio funciono. Cronologia del seguimiento: 21 abr incumplio → 22 abr otro grupo cumplio → 24 abr otro grupo cumplio → 27 abr otro grupo cumplio → 28 abr grupo original cumplio + mejora. |
| A8 | Reunion Calidad acreditacion (Ma Elena + Patricia + Zuleidy + Julia) | Patricia + Maria Elena + Zuleidy + Julia | Lun 27 abr 14:00 | Sin reunion no se alinean los requisitos ITAES y se acumula trabajo previo a auditoria | ✅ COMPLETADA — 27 abr 14:00-16:30 (2.5h). Revision completa de documentos y requisitos ITAES enfermeria. Resultado: plan de trabajo mie 29 abr al vie 8 may (ver A10). |
| A10 | Proyecto ITAES enfermeria — trabajar requisitos + redactar plan de mejoras para no conformidades detectadas | Patricia + Maria Elena + Zuleidy + Julia | **Arranque jue 30 abr (mañana)** — Vie 8 may | Sin cumplimiento ITAES la institucion compromete la acreditacion | ABIERTA — 27 abr 2026. **Plan revisado 29 abr:** Patricia con reagudizacion familiar, no retoma presencial mie 29. **Arranque ITAES movido a jue 30 abr por la mañana** (excepcion al jueves no habil). Patricia + Maria Elena + Zuleidy + Julia. Resto del calendario ITAES sin cambio. |
| A11 | **Pase de turno enfermeria — definicion final:** SOLO ASISTENCIAL (incluye personal de apoyo al paciente). Se RETIRA la seccion administrativa (gestoras). Calidad creara un procedimiento NUEVO de pase de turno administrativo aparte. | Patricia (asistencial) + Julia/Calidad (administrativo nuevo aparte) | Esta semana | Sin la separacion clara, el procedimiento mezcla logicas distintas y no sirve a ninguno de los dos publicos | 🟢 REDEFINIDA — **30 abr 2026 con Julia:** se decidio que el procedimiento de pase de turno asistencial se mantenga acotado al ambito asistencial. La parte administrativa de gestoras pasa a ser responsabilidad de Calidad como **procedimiento nuevo separado**. Esto simplifica el documento de Patricia y libera la dependencia de Monica Soruco para validacion (ya no aplica a este procedimiento). |
| A13 | Trabajar con el **personal de apoyo al paciente** la actualizacion del instrumento de pase de turno y su aplicacion practica | Patricia + equipo de apoyo | Piloto arranca lun 5 may 2026 | Sin actualizacion el personal de apoyo sigue usando un proceso no formalizado en el manual | 🟢 **AVANZA — 2 may 2026.** Reunion realizada con personal de apoyo al paciente, **formato V1 consensuado**. Estructura con 6 bloques x 3 turnos (estado del servicio, actividades, incidentes, pendientes, bioseguridad, firmas). Piloto operativo arranca **lun 5 may**. Documento transcrito en `evidencia/00-reglas-generales/instrumento-pase-turno-personal-apoyo-V1.md`. Original en `RAIZEN 5/ROLES Y BOLETAS/APOYO AL PACIENTE/V1 PASE DE TURNO PERS APOYO.docx`. |
| A14 | **Revision del manual de organizacion del area de Internacion General** — pendiente identificado en sesion ITAES del 30 abr | Patricia + Maria Elena + Julia | Dentro del marco del proyecto ITAES (29 abr–8 may) | Sin manual de organizacion actualizado, falta requisito ITAES de Internacion | ABIERTA — 30 abr 2026. Salio en la revision de formularios ITAES con Julia. |
| A15 | **Procedimiento NUEVO de pase de turno administrativo** (gestoras) — responsabilidad de Calidad | Julia + equipo de Calidad | A definir por Calidad | Sin procedimiento administrativo formal, las gestoras siguen sin documento propio | ABIERTA — 30 abr 2026. Decidido junto con A11. Patricia queda solo en seguimiento informal. |
| A16 | **Plan de cierre Fase 3 (Internacion)** — calendario de actividades para alcanzar 50/50 + cierre formal | Patricia + Lotty (lecciones) + Pedro (decision UCI Adulto) | Sab 2 may → Jue 8 may | Sin cierre formal no se valida la metodologia para escalar a UCI Adulto | 🟢 PLANIFICADA — 30 abr 2026. **Calendario acordado:** Sab 2 may = 4to C pase mañana→tarde (~4 nuevas) **— modelo apoyo Zuleidy** (6to dia consecutivo del modelo). Lun 5 may = 6to C pase mañana→tarde + cerrar Recuperacion. Mar 6 may = remanentes + consolidacion. Mie 7 may = lecciones con Lotty. Jue 8 may = cierre + decision UCI Adulto con Pedro. |
| A12 | Cierre del complemento de hemoderivados — integrado en el manual a continuacion del procedimiento de administracion endovenosa. **Fuente del contenido:** Servicio Transfusional (datos aportados a Patricia). Pendiente: revision por equipo del manual | Patricia + equipo del manual + Servicio Transfusional (validacion final) | Sin fecha — depende del avance del equipo del manual | Sin cierre, hemoderivados queda como complemento sin validacion oficial | ABIERTA — 27 abr 2026 — contenido respaldado por Servicio Transfusional |
...
| A9 | Seguimiento a Calidad (Julia) — respuesta a observaciones sobre malla de reportes de eventos de enfermeria. **Correo original:** vie 17 abr. **Reenviado:** vie 24 abr. | Julia + su equipo | Hoy jue 30 abr por la tarde — Julia y equipo revisan | Sin respuesta formal el tema queda ambiguo y se acumulan observaciones sin cierre. | ⏳ ESPERA HOY 30 ABR (TARDE) — Julia y su equipo revisan la planilla de eventos por la tarde del 30 abr. Pendiente recibir la respuesta. |
...
- **Reunion Calidad ITAES (27 abr 14:00-16:30):** Maria Elena + Patricia + Zuleidy + Julia revisaron requisitos ITAES enfermeria. Plan: trabajar requisitos + plan de mejoras del **mie 29 abr al vie 8 may**.
- **Avances en manual de procedimientos (27 abr):** (a) Pase de turno actualizado como **TRANSVERSAL** con 3 secciones: enfermeria asistencial + gestoras administrativas + personal de apoyo al paciente. Pendiente validacion de **Monica Soruco** para la seccion de gestoras. (b) Hemoderivados integrado al manual a continuacion del procedimiento de administracion endovenosa.
