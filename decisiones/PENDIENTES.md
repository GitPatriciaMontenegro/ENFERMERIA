...
| A11 | Pasar el procedimiento actualizado de **pase de turno (transversal)** a **Monica Soruco** para validacion de la seccion de **gestoras administrativas** | Patricia | Esta semana | Sin validacion de gestoras, la seccion correspondiente no queda formalmente revisada antes de subir el procedimiento al manual oficial | ABIERTA — 27 abr 2026 |
