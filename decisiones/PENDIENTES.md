...
| A11 | Pasar el procedimiento actualizado de **pase de turno (transversal)** a Calidad para revision con las areas afectadas (gestoras administrativas, etc.) | Patricia → Julia (Calidad) → Monica Soruco y otras | Esta semana | Sin validacion de las areas, la seccion correspondiente no queda formalmente revisada antes de subir el procedimiento al manual oficial | 🟢 EN PROCESO — 28 abr 2026: Patricia actualizo el procedimiento via remota y lo compartio con **Julia (Calidad)**, quien hara de puente con areas administrativas (gestoras / Monica Soruco) y otras involucradas. Cambio de flujo: Julia canaliza la revision multi-area. |
| A13 | Trabajar con el **personal de apoyo al paciente** la actualizacion del instrumento de pase de turno y su aplicacion practica | Patricia | A definir (post-retorno presencial — pospuesto desde el 29 abr por reagudizacion familiar) | Sin actualizacion el personal de apoyo sigue usando un proceso no formalizado en el manual | ABIERTA — 28 abr 2026. Patricia se hace cargo. **Pospuesto sin fecha** (29 abr): reagudizacion del problema familiar de Patricia. |
...
| A9 | Seguimiento a Calidad (Julia) — respuesta a observaciones sobre malla de reportes de eventos de enfermeria. **Correo original:** vie 17 abr. **Reenviado:** vie 24 abr. | Julia + su equipo | Hasta mie 29 abr 2026 — Julia coordinara con su equipo y enviara la malla con respuestas | Sin respuesta formal el tema queda ambiguo y se acumulan observaciones sin cierre (pain point de seguimiento externo). | ⏳ ESPERA MIE 29 ABR — 27 abr 2026: en la reunion A8 Julia confirmo que la malla con observaciones aun no fue enviada; coordinara con su equipo de Calidad y la enviara hasta el miercoles 29 abr. |
