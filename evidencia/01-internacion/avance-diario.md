# Avance Diario — Internacion General

> Registrar avance cada dia de trabajo. Sin registro = sin evidencia.
...
### Fecha: (dia/mes)
- **Personas atendidas hoy:** (numero)
- **Acumulado:** (total hasta hoy) / 50
- **Que se hizo:**
  - (describir brevemente)
- **Problemas/bloqueos:**
  - (si los hubo, describir)
- **Siguiente paso:**
  - (que sigue manana)

---

<!-- Copiar el bloque de arriba para cada dia de trabajo -->
...
- **Problemas/bloqueos:**
  - Ninguno que bloquee avance. 2 desvios de protocolo registrados como hallazgos.
- **Siguiente paso:**
  - lun 20 abr — Grupo 2 (~8 personas). Cerrar las 2 personas pendientes del Grupo 1 si hay oportunidad.
